...
public class Limelight extends SubsystemBase {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Back LL/X Offset", getXOffset(limelight));
        SmartDashboard.putBoolean("Back LL/Has Target", hasTarget(limelight));
        SmartDashboard.putNumber("Back LL/Target ID", getTargetId(limelight));
    }
}